...
function results = run_SPBACF(seq, video_path, lr)
...
params.search_area_scale = 6;                   % the size of the training/detection area proportional to the target size
...
params.affsig = [4,4,0.01,0,0,0]; 

% Debug and visualization 
params.visualization = 1; 

% Run the main function
results = SPBACF_optimized(params);
